...
int main(void)
{
    ...
    while (1)
    {
        ...
        //     step = 1;
        // }
        // if ((step == 1 || step == 2) && objectDif < -CALIPILE_TRSHLD)
        // {
        ...
        //     step = 2;
        // }
        // if (step == 2 && objectDif > -CALIPILE_TRSHLD)
        // {
